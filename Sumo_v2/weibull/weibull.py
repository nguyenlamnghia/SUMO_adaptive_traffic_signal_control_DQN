...
flows = [
    {"id": "flow1", "type": "car", "from": "HQC_J4_J3", "vehsPerHour": 100, "total_vehicles": 222},
    {"id": "flow2", "type": "motorbike", "from": "HQC_J4_J3", "vehsPerHour": 525, "total_vehicles": 409},
    {"id": "flow3", "type": "bus", "from": "HQC_J4_J3", "vehsPerHour": 5, "total_vehicles": 0},
    {"id": "flow4", "type": "truck", "from": "HQC_J4_J3", "vehsPerHour": 1, "total_vehicles": 2},
    {"id": "flow5", "type": "car", "from": "HQC_J2_J3", "vehsPerHour": 100, "total_vehicles": 270},
    {"id": "flow6", "type": "motorbike", "from": "HQC_J2_J3", "vehsPerHour": 612, "total_vehicles": 634},
    {"id": "flow7", "type": "bus", "from": "HQC_J2_J3", "vehsPerHour": 6, "total_vehicles": 0},
    {"id": "flow8", "type": "truck", "from": "HQC_J2_J3", "vehsPerHour": 2, "total_vehicles": 7},
    {"id": "flow9", "type": "car", "from": "PVB_J6_J3", "vehsPerHour": 500, "total_vehicles": 771},
    {"id": "flow10", "type": "motorbike", "from": "PVB_J6_J3", "vehsPerHour": 2500, "total_vehicles": 2033},
    {"id": "flow11", "type": "bus", "from": "PVB_J6_J3", "vehsPerHour": 4, "total_vehicles": 22},
    {"id": "flow12", "type": "truck", "from": "PVB_J6_J3", "vehsPerHour": 6, "total_vehicles": 4},
    {"id": "flow13", "type": "car", "from": "PVB_J0_J3", "vehsPerHour": 455, "total_vehicles": 1642},
    {"id": "flow14", "type": "motorbike", "from": "PVB_J0_J3", "vehsPerHour": 2235, "total_vehicles": 4618},
    {"id": "flow15", "type": "bus", "from": "PVB_J0_J3", "vehsPerHour": 3, "total_vehicles": 30},
    {"id": "flow16", "type": "truck", "from": "PVB_J0_J3", "vehsPerHour": 5, "total_vehicles": 24},
]
