...
def get_state():  #3&4. Constraint 3 & 4
    ...
    q_PVB_J6_J3_0 = get_queue_length(detector_PVB_J6_J3_0)
    q_PVB_J6_J3_1 = get_queue_length(detector_PVB_J6_J3_1)
    q_PVB_J6_J3_2 = get_queue_length(detector_PVB_J6_J3_2)

    q_PVB_J0_J3_0 = get_queue_length(detector_PVB_J0_J3_0)
    q_PVB_J0_J3_1 = get_queue_length(detector_PVB_J0_J3_1)
    q_PVB_J0_J3_2 = get_queue_length(detector_PVB_J0_J3_2)

    q_HQC_J2_J3_0 = get_queue_length(detector_HQC_J2_J3_0)
    q_HQC_J4_J3_0 = get_queue_length(detector_HQC_J4_J3_0)
...
def apply_action(action, tls_id="clusterJ12_J2_J3_J6_#2more"): #5. Constraint 5
    """
...
def train_dqn(batch_size):
    """
    Perform a single batch update using experiences from the replay buffer.
    """
...
for step in range(TOTAL_STEPS):
    ...
    done = (step == TOTAL_STEPS - 1)  # End episode at max steps
