...
def apply_action(current_phase, action, green_time):
    # count = 0
...
for i in range(EPOCHS):
    ...
    while step < STEP_SIMULATION:
        ...
        throughput, incoming_vehicles_count, classified_vehicles = apply_action(current_phase, action, green_time)
        ...
        if current_phase == 0:
            ...
            reward = throughput/(green_time + YELLOW_TIME + RED_TIME)*3.5
